...
Napi::Value sweph_gauquelin_sector(const Napi::CallbackInfo& info) {
	...
	if(!sweph_double_array_converter(geopos, 3, info[5])) {
		Napi::TypeError::New(env, args31[6].second).ThrowAsJavaScriptException();
		return env.Null();
	}
	double sect;
	char serr [AS_MAXCH] = "";
...
constexpr std::pair<int, const char*> args36[] = {
...
Napi::Value sweph_get_ayanamsa_name(const Napi::CallbackInfo& info) {
	Napi::Env env = info.Env();
	if(!sweph_type_check(args36, info)) {
		return env.Null();
	}
...
Napi::Value sweph_heliacal_pheno_ut(const Napi::CallbackInfo& info) {
	...
	if(!sweph_double_array_converter(dgeo, 3, info[1])) {
		Napi::TypeError::New(env, args43[2].second).ThrowAsJavaScriptException();
		return env.Null();
	}
	double datm [4];
	if(!sweph_double_array_converter(datm, 4, info[2])) {
		Napi::TypeError::New(env, args43[3].second).ThrowAsJavaScriptException();
		return env.Null();
	}
	double dobs [6];
	if(!sweph_double_array_converter(dobs, 6, info[3])) {
		Napi::TypeError::New(env, args43[4].second).ThrowAsJavaScriptException();
		return env.Null();
	}
	char serr [AS_MAXCH] = "";
	double ret [50];
...
Napi::Value sweph_heliacal_ut(const Napi::CallbackInfo& info) {
	...
	double dgeo [3];
	if(!sweph_double_array_converter(dgeo, 3, info[1])) {
		Napi::TypeError::New(env, args44[2].second).ThrowAsJavaScriptException();
		return env.Null();
	}
	double datm [4];
	if(!sweph_double_array_converter(datm, 4, info[2])) {
		Napi::TypeError::New(env, args44[3].second).ThrowAsJavaScriptException();
		return env.Null();
	}
	double dobs [6];
	if(!sweph_double_array_converter(dobs, 6, info[3])) {
		Napi::TypeError::New(env, args44[4].second).ThrowAsJavaScriptException();
		return env.Null();
	}
	char serr [AS_MAXCH] = "";
	double ret [50];
...
Napi::Value sweph_house_pos(const Napi::CallbackInfo& info) {
	...
	if(!sweph_double_array_converter(planet, 2, info[4])) {
		Napi::TypeError::New(env, args53[5].second).ThrowAsJavaScriptException();
		return env.Null();
	}
	char serr [AS_MAXCH] = "";
	char sys = info[3].As<Napi::String>().Utf8Value()[0];
...
Napi::Value sweph_lun_eclipse_how(const Napi::CallbackInfo& info) {
	...
	double geopos [3];
	if(!sweph_double_array_converter(geopos, 3, info[2])) {
		Napi::TypeError::New(env, args59[3].second).ThrowAsJavaScriptException();
		return env.Null();
	}
	double attr [20];
	char serr [AS_MAXCH] = "";
...
Napi::Value sweph_lun_eclipse_when_loc(const Napi::CallbackInfo& info) {
	...
	double geopos [3];
	if(!sweph_double_array_converter(geopos, 3, info[2])) {
		Napi::TypeError::New(env, args61[3].second).ThrowAsJavaScriptException();
		return env.Null();
	}
	double ret [10];
	double attr [20];
...
Napi::Value sweph_lun_occult_when_loc(const Napi::CallbackInfo& info) {
	...
	if(!sweph_double_array_converter(geopos, 3, info[4])) {
		Napi::TypeError::New(env, args63[5].second).ThrowAsJavaScriptException();
		return env.Null();
	}
	double ret [10];
	double attr [20];
...
Napi::Value sweph_rise_trans(const Napi::CallbackInfo& info) {
	...
	double geopos [3];
	if(!sweph_double_array_converter(geopos, 3, info[5])) {
		Napi::TypeError::New(env, args79[6].second).ThrowAsJavaScriptException();
		return env.Null();
	}
	double ret;
	char serr [AS_MAXCH] = "";
...
Napi::Value sweph_rise_trans_true_hor(const Napi::CallbackInfo& info) {
	...
	double geopos [3];
	if(!sweph_double_array_converter(geopos, 3, info[5])) {
		Napi::TypeError::New(env, args80[6].second).ThrowAsJavaScriptException();
		return env.Null();
	}
	double ret;
	char serr [AS_MAXCH] = "";
...
Napi::Value sweph_sol_eclipse_how(const Napi::CallbackInfo& info) {
	...
	double geopos [3];
	if(!sweph_double_array_converter(geopos, 3, info[2])) {
		Napi::TypeError::New(env, args94[3].second).ThrowAsJavaScriptException();
		return env.Null();
	}
	double attr [20];
	char serr [AS_MAXCH] = "";
...
constexpr std::pair<int, const char*> args95[] = {
	{ 4, "Expecting 4 arguments: tjd_start, ifl, ifltype, backward" },
	{ NUMBER, "Argument 1 should be a number - julian day in universal time" },
	{ NUMBER, "Argument 2 should be a number - ephemeris flag" },
	{ NUMBER, "Argument 3 should be a number - eclipse type" },
...
Napi::Value sweph_sol_eclipse_when_glob(const Napi::CallbackInfo& info) {
	Napi::Env env = info.Env();
	if(!sweph_type_check(args95, info)) {
		return env.Null();
	}
	double ret [10];
	char serr [AS_MAXCH] = "";
...
constexpr std::pair<int, const char*> args97[] = {
...
Napi::Value sweph_sol_eclipse_where(const Napi::CallbackInfo& info) {
	Napi::Env env = info.Env();
	if(!sweph_type_check(args97, info)) {
		return env.Null();
	}
	double geopos [10];
	double attr [20];
...
constexpr std::pair<int, const char*> args98[] = {
...
Napi::Value sweph_split_deg(const Napi::CallbackInfo& info) {
	Napi::Env env = info.Env();
	if(!sweph_type_check(args98, info)) {
		return env.Null();
	}
	int deg;
	int min;
...
constexpr std::pair<int, const char*> args99[] = {
	{ 1, "Expecting 1 arguments: tjd_ut" },
	{ NUMBER, "Argument 1 should be a number - julian day in universal time" }
};
...
Napi::Value sweph_time_equ(const Napi::CallbackInfo& info) {
	Napi::Env env = info.Env();
	if(!sweph_type_check(args99, info)) {
		return env.Null();
	}
	double e;
	char serr [AS_MAXCH] = "";
...
constexpr std::pair<int, const char*> args100[] = {
...
Napi::Value sweph_utc_time_zone(const Napi::CallbackInfo& info) {
	Napi::Env env = info.Env();
	if(!sweph_type_check(args100, info)) {
		return env.Null();
	}
	int year;
	int month;
...
constexpr std::pair<int, const char*> args101[] = {
...
Napi::Value sweph_utc_to_jd(const Napi::CallbackInfo& info) {
	Napi::Env env = info.Env();
	if(!sweph_type_check(args101, info)) {
		return env.Null();
	}
	double ret [2];
	char serr [AS_MAXCH] = "";
...
constexpr std::pair<int, const char*> args103[] = {
...
Napi::Value sweph_vis_limit_mag(const Napi::CallbackInfo& info) {
	Napi::Env env = info.Env();
	if(!sweph_type_check(args103, info)) {
		return env.Null();
	}
	double dgeo [3];
	if(!sweph_double_array_converter(dgeo, 3, info[1])) {
		Napi::TypeError::New(env, args103[2].second).ThrowAsJavaScriptException();
		return env.Null();
	}
	double datm [4];
	if(!sweph_double_array_converter(datm, 4, info[2])) {
		Napi::TypeError::New(env, args103[3].second).ThrowAsJavaScriptException();
		return env.Null();
	}
	double dobs [6];
	if(!sweph_double_array_converter(dobs, 6, info[3])) {
		Napi::TypeError::New(env, args103[4].second).ThrowAsJavaScriptException();
		return env.Null();
	}
	char serr [AS_MAXCH] = "";
	double ret [8];
